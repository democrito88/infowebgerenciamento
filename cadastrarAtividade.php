...
$resultado = mysql_query("SELECT nomeProcesso, dataInicial, dataFinal FROM processo WHERE idProcesso = ".$idProcesso);
	...
	function validateForm(){
		...
		if (dataFinal==null || dataFinal=="")
		 ...
		 if (responsavel==null || responsavel=="")
		  {
		  alert("Preencha o campo de nome do responsavel.");
		  return false;
		  }
...
<div id="main_container">
 <div class="header">
  ...
  <div class="main_content">
  	...
  	<div class="center_content" style="padding:50px;">
    <form  enctype="multipart/form-data" name="form" id="form" action="validarAtividade.php?idProcesso=<?php echo $idProcesso;?>" method="post" onsubmit="return validateForm()">
    	<div align="center"><h3><?php echo $nomeProcesso;?></h3></div>
    	<div id="form">
        <h2>Preencha os dados para cadastrar a atividade</h2>
        <p>
        	<input type="text" name="nomeAtividade" placeholder="Nome da Atividade" />
            <label for="nomeAtividade">Nome Atividade</label>
        </p>
        <p>
        	<input type="text" id="calendario" name="dataInicial" placeholder="Data Inicial" />
            <label for="dataInicial">Data Inicial</label>
        </p>
        <p>
        	<input type="text" id="calendario1" name="dataFinal" placeholder="Data Final" />
            <label for="dataFinal">Data Final</label>
        </p>
        <p>
            <?php selectUsuario()?>
            <label for="responsavel">Atribuído para</label>
        </p>
        <p>
        	<textarea cols="7" rows="2" name="situacao" placeholder="Situação"></textarea>
            <label for="situacao">Situação</label>
        </p>
        <p>
        	<input type="file" name="arquivo[]" multiple style="width:345px;" />
            <label for="arquivo">Arquivo</label>
        </p>
        <p>
            <select name="status" form="form">
        ...
        <p class="submit">
            <input type="submit" value="Concluir" onclick="validateForm(this.form)" />
        </p>
